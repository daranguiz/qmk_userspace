...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x6_3(
        ...
        KC_ESC              , LGUI_T(KC_A)        , LALT_T(KC_R)        , LCTL_T(KC_S)        , LSFT_T(KC_T)        , KC_D                ,
        KC_LSFT             , KC_Z                , LT(FUN, KC_X)       , KC_C                , KC_V                , KC_B                ,
        KC_J                , KC_L                , KC_U                , KC_Y                , KC_QUOT             , KC_BSLS             ,
        KC_H                , LSFT_T(KC_N)        , LCTL_T(KC_E)        , LALT_T(KC_I)        , LGUI_T(KC_O)        , KC_MINS             ,
        KC_K                , KC_M                , KC_COMM             , ALGR_T(KC_DOT)      , KC_SLSH             , KC_RSFT             ,
