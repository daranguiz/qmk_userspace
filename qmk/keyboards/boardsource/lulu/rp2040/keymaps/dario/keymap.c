...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_BUNYA] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , KC_B                , KC_L                , KC_M                , KC_C                , KC_Z                , KC_J                , KC_F                , KC_O                , KC_U                , KC_COMM             , KC_NO               ,
        KC_NO               , LGUI_T(KC_N)        , LALT_T(KC_R)        , LCTL_T(KC_T)        , LSFT_T(KC_D)        , KC_P                , KC_Y                , LSFT_T(KC_H)        , LCTL_T(KC_A)        , LALT_T(KC_E)        , LGUI_T(KC_I)        , KC_NO               ,
        KC_NO               , KC_X                , KC_Q                , KC_V                , KC_G                , KC_W                , KC_NO               , KC_NO               , KC_SCLN             , KC_K                , KC_QUOT             , KC_MINS             , KC_DOT              , KC_NO               ,
    ...
    [MEDIA_NIGHT] = LAYOUT(
        KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
        KC_NO               , DF(BASE_NIGHT)      , DF(BASE_GALLIUM)    , DF(BASE_BUNYA)      , DF(BASE_RACKET)     , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               , KC_NO               ,
