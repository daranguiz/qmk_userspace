...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_GALLIUM] = LAYOUT(
        ...
        KC_W                , KC_Z                , KC_K                , KC_F                , KC_QUOT             , KC_MINS             , KC_COMM             , LT(NUM_NIGHT, KC_BSPC), LT(SYM_NIGHT, KC_R) , LSFT_T(KC_DEL)      , LSFT_T(KC_TAB)      , LT(NAV_NIGHT, KC_SPC), LT(MEDIA_NIGHT, KC_ENT)
    ),
    [FUN] = LAYOUT(
